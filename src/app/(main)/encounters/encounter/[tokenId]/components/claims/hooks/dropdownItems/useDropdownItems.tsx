...
const useDropdownItems = () => {
    const {formik, handleAddDiagnosis} = useClaimsFormContext()
    ...
    const {diagnosisItems : mainConditionItems} = useDiagnosis()

    // const mainConditionItems: DropdownItem[] = [
    //     { key: "I10", label: "I10 - Chronic diarrhoea (> 2 weeks)", onClick: () => handleAddDiagnosis("I10") },
    //     { type: "divider", key: "divider-1" },
    //     { key: "bacterial_gastroenteritis", label: "bacterial_gastroenteritis", onClick: () => handleAddDiagnosis("bacterial_gastroenteritis") },
    //     { type: "divider", key: "divider-2" },
    //     { key: "N18", label: "N18 - Acute Hepatitis", onClick: () => handleAddDiagnosis("N18") },
    //     { type: "divider", key: "divider-3" },
    //     { key: "I25", label: "I25 - Plasma Cell Myeloma", onClick: () => handleAddDiagnosis("I25") },
    //     { type: "divider", key: "divider-4" },
    //     { key: "J45", label: "J45 - Asthma", onClick: () => handleAddDiagnosis("J45") },
    //     { type: "divider", key: "divider-5" },
    //     { key: "J44", label: "J44 - Chronic Obstructive Pulmonary Disease (COPD)", onClick: () => handleAddDiagnosis("J44") },
    //     { type: "divider", key: "divider-6" },
    //     { key: "J18", label: "J18 - Pneumonia (J18)", onClick: () => handleAddDiagnosis("J18") },
    //     { type: "divider", key: "divider-7" },
    //     { key: "I63", label: "I63 - Stroke (Cerebrovascular Accident) (I63)", onClick: () => handleAddDiagnosis("I63") },
    // ];
